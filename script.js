...
$(document).ready(function () {
    ...
    var typed = new Typed(".typing",{
        strings: ["BBA Student","","Skill Developer","Cross-Disciplinary Enthusiast"],
        typeSpeed: 100,
        backSpeed: 60,
        loop: true,
        fadeOut: true,
    ...
    var typed = new Typed(".typing-2",{
        strings: ["Cross-Disciplinary Enthusiast","BBA Student","Skill Developer","Cross-Disciplinary Enthusiast"],
        typeSpeed: 100,
        backSpeed: 60,
        loop: true,
    });
